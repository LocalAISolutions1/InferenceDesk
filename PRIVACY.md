...
- Contact support (e.g., email address, the content of your message)
- Submit feedback
...
Depending on your settings and App version, the App may offer optional diagnostic collection such as:
- Crash reports (stack traces, error logs)
- Basic device/app info (OS version, App version, architecture)
- Feature usage counts (e.g., “opened settings,” “download started”)

**We recommend keeping diagnostics OFF by default unless you specifically want them enabled.**  
...
(If you plan to always keep telemetry off: you can replace this section with “We do not collect telemetry or crash reports.”)
...
- Disable optional diagnostics/telemetry
...
We may update this Privacy Policy from time to time. If we make material changes, we will post the updated Policy in this repository and update the Effective Date. Your continued use of the App after the effective date means you accept the updated Policy.
